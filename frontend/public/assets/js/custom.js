      ...
      let htmlString = `
                ...
                <div class="col-md-6 col-xl-4 mb-5">
                    ...
                    <div class="card blog-post-card">
                        <img class="card-img-top" src="data:${element.contentType};base64,${
        element.imageData
      }">
                        <div class="card-body">
                            <h5 class="card-title"><a class="theme-link" href="https://blog.riosr.com/BlogPosts/UrlFriendly/${
                              element.slug
                            }" target="_blank">${element.title}</a></h5>
                            <p class="card-text">${element.abstract}</p>
                            <p class="mb-0"><a class="text-link" href="https://blog.riosr.com/BlogPosts/UrlFriendly/${
                              element.slug
                            }" target="_blank">Read more &rarr;</a></p>
                        </div>
    ...
    $.ajax({
      ...
      .done(function (response) {
        ...
        if (response == 'success') {
          ...
          feedbackEl
            .addClass('error')
            .html('Server error! Please check your browser console log for more details.')
            .fadeIn(200);
          setTimeout(function () {
...
// Fetch and display the current counter value on page load
async function fetchCounter() {
  try {
    console.log('Fetching counter from', counterApiUrl);
